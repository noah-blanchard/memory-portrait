  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Switch langue en haut-droite de la card */}
        <LanguageSwitch position="absolute" offset={12} />

        {/* Contenu */}
        <Box style={{ position: "relative", zIndex: 1, overflow: "auto", scrollbarGutter: "stable" }}>
          {children}
        </Box>
      </Card>
    </Box>
