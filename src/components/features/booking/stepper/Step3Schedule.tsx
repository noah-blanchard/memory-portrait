...
import { NumberInput as ButtonNumberInput, TimeInput } from '@/components/ui/forms';
      ...
      {(styles) => (
        <Box style={styles}>
          <Stack gap={isMobile ? 'lg' : 'md'}>
            ...
            {/* Weather Widget */}
            <WeatherWidget 
              date={form.values.date as Date | null} 
              location={(form.values.location as string) || 'Montreal'} 
            />
